...
const MERCHANT_CATEGORY_MAP = [
  ...
  { keywords: ['HEB','KROGER','WHOLE FOODS','WHOLEFDS','ALDI','PUBLIX','SAFEWAY','TRADER JOE','SPROUTS',"SAM'S CLUB",'SAMS CLUB','SAMS SCAN','KEEMAT','FOOD LION','GIANT','MEIJER','WINN-DIXIE','FIESTA','COSTCO'], category: 'groceries' },
  ...
  { keywords: ['SHELL','CHEVRON','EXXON','BP GAS','MOBIL','VALERO','MARATHON','SUNOCO','CIRCLE K','WAWA','SPEEDWAY','PILOT TRAVEL','SAMS FUEL',"SAM'S FUEL",'COSTCO GAS','UBER*','LYFT','PARKING','TOLLWAY','PIKE PASS','EZPASS','AMTRAK','METRO'], category: 'transport' },
